/**
 * TweetNaCl (pronounced "tweet salt")
 ...
 *  functions used by applications. TweetNaCl is a self-contained public-domain
 *  C library, so it can easily be integrated into applications."
 *
 * Contributors listed:
 ...
 *
 * source: https://tweetnacl.cr.yp.to/ (accessed 6/11/2019)
 */
#ifndef TWEETNACL_H
#define TWEETNACL_H
